				...
				<div class="col-sm-9 padding-right" id="main-display">				
					<div class="features_items"><!--New Items-->
						...
						<%
							...
							ResultSet rs2 = st2.executeQuery("select * from brand where brandId = "+bId);
							rs2.next();
							
							
							rs = st1.executeQuery("select * from product where brand = '"+ rs2.getString("brandName") +"' ORDER BY addDate"); // this is for name
							while (rs.next()) {
						...
						<div class="col-sm-4 categorizedProduct">
